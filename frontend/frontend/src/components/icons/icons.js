...
export const CameraIcon = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"}
        ...
        <Path d="M11.9998 6H12.0088" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
              strokeLinejoin="round"/>
    </Svg>
);
...
export const PostIcon = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24}
         color={"#FFF"} fill={"none"}  {...props}>
        <Circle cx="1.5" cy="1.5" r="1.5" transform="matrix(1 0 0 -1 16 8.00024)" stroke="currentColor"
                strokeWidth="2"
        ...
        <Path
            ...
            stroke="currentColor" strokeWidth="2"/>
        <Path d="M7.00002 14.0002L10 17.0002" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
              strokeLinejoin="round"/>
    </Svg>
);
...
export const VideoIcon = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"}
         fill={"none"} {...props}>
        <Path d="M11 8L13 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        <Path
